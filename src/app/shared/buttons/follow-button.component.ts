...
export class FollowButtonComponent {
  ...
  toggleFollowing() {
    ...
    this.userService.isAuthenticated.pipe(concatMap(
      (authenticated) => {
        // Не аутентифицирован? Нажать на экран входа в систему
        if (!authenticated) {
          this.router.navigateByUrl('/login');
          return of(null);
        }

        // Подпишитесь на этот профиль, если мы еще не
        ...
        // В противном случае откажитесь от подписки на этот профиль
        } else {
